...
import 'package:scrren/phadd2.dart';

class Phadd extends StatefulWidget {
  const Phadd({super.key});

  @override
  State<Phadd> createState() => _PhaddState();
}

class _PhaddState extends State<Phadd> {
  int currentIndex = 0;
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text("(Photographers Name) Account",
              style: TextStyle(
                  color: Colors.blue,
                  fontSize: 18,
                  fontFamily: 'Poppins',
